...
path, extension_ = os.path.splitext( args.video_path)

DLCScorer = deeplabcut.analyze_videos( args.config, [ args.video_path ], videotype= extension_, save_as_csv= args.save_csv)
print("Result path : ",  path + DLCScorer + '.csv')