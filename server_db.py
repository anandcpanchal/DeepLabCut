...
class ServerDB:
	...
	def init_record_table( self, connection_ia):
		...
		make_table = "CREATE TABLE " + self.table + " (ITEM INT NOT NULL AUTOINCREMENT PRIMARY KEY UNIQUE, ID CHAR(256) UNIQUE, VIDEO CHAR(256),METADATA CHAR(1024), PROCESSED INT, PUBLISHED INT, PRIMARY_COUNT INT, SECONDARY_COUNT INT)"
